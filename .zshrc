...
if [[ ! -e $syn_hl_plugin_location ]]; then
    git clone https://github.com/zsh-users/zsh-syntax-highlighting.git $syn_hl_plugin_location
fi
...
plugins+=zsh-syntax-highlighting   # has to be in last position
